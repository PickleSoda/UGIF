            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className=" text-white p-6  rounded-lg w-full max-w-lg cursor-default absolute overflow-hidden"
                    >
                        <div className="relative flex flex-col items-center  z-10">
                            ...
                            <IonButton
                                shape="round"
                                mode="ios">
                                <IonIcon className="h-10 w-10 -ml-4" icon={addCircle} slot="start"></IonIcon>
                                Customise
                            </IonButton>
