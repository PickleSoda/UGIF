  ...
  return (
    ...
    <IonContent fullscreen scrollY={false} className="bg-white flex flex-col items-center justify-center">
      ...
      <div className="input-container">
        ...
        <IonItem lines="none" className="input-item">
          <IonInput value={formData.confirmPassword}
                    onInput={(e: any) => handleInputChange(e)}
                    type="password"
                    required
      ...
      <div className="logins-container">
        <IonButton expand="block" className="signin-button" onClick={handleSignUp} disabled={loading}>
          Sign up
        </IonButton>
      ...
      <p className="register-link">
        Already have an account? <span onClick={handleSignIn} className='signup-span'>Sign In</span>
      </p>
    </IonContent>
  </IonPage>
  );
